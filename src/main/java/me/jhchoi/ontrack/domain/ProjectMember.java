...
public class ProjectMember {
    ...
    private LocalDateTime regDate; // 프로젝트에 합류한 날

    @Builder
    public ProjectMember(Long projectId, Long userId, String nickname, String position, String capacity, LocalDateTime regDate) {
